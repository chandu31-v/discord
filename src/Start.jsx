...
function Start() {
    ...
    return (
        <div className="max-w-screen min-h-screen">
            ...
            <div className="bg-[#404eed] min-h-5/6 min-[500px]:min-h-screen max-w-screen bg-[url(./resource/start_bg.svg)]">

                <header className="flex max-w-screen max-h-26">
                    <img className="sm:px-18 md:px-24 py-2.5" src={Logo} alt="Discord" />
                    <div className="text-white w-4/6 md:w-3/5 py-4 text-center text-[16px]">
                        <button className="px-[2px] md:px-2">Download</button>
                        <button className="px-[2px] md:px-2">Nitro</button>
                        <button className="px-[2px] md:px-2">Safety</button>
                        <button className="px-[2px] md:px-2">Support</button>
                        <button className="px-[2px] md:px-2">Blog</button>
                        <button className="px-[2px] md:px-2">Careers</button>
                    </div>
                    <div className="flex w-1/6 md:w-1/5 items-center text-[16px] mr-2">
                        <span className="flex justify-center mx-1 md:m-3 max-h-12">
            ...
            <div className="flex flex-col min-[500px]:flex-row min-h-5/6 min-[500px]:min-h-screen pt-10 min-[500px]:mt-0 justify-center">
                <img className="w-full min-[500px]:w-3/6" src={Start_bg1} alt="image-2" />
                <div className="flex w-full min-[500px]:w-3/6 justify-center items-center">
                    <div className="w-3/5">
                        <h1 className="text-3xl min-[500px]:text-6xl font-bold pb-4">Create an invite-only place where you belong</h1>
            ...
            <div className="flex flex-col min-[500px]:flex-row min-h-5/6 min-[500px]:min-h-screen pt-10 min-[500px]:mt-0 justify-center">
                {/* <img className="w-full min-[500px]:w-3/6" src={Start_bg2} alt="Image-2" /> */}
                <div className="flex w-full min-[500px]:w-3/6 justify-center items-center">
                    <div className="w-3/5">
                        <h1 className="text-3xl min-[500px]:text-6xl font-bold pb-4">Where hanging out is easy</h1>
            ...
            <div className="flex flex-col min-[500px]:flex-row min-h-5/6 min-[500px]:min-h-screen pt-10 min-[500px]:mt-0 justify-center">
                <img className="w-full min-[500px]:w-3/6" src={Start_bg3} alt="Image-3" />
                <div className="flex w-full min-[500px]:w-3/6 justify-center items-centers">
                    <div className="w-3/5">
                        <h1 className="text-3xl min-[500px]:text-6xl font-bold pb-4">From few to a fandom</h1>
            ...
            <div className="bg-slate-50 min-h-screen">
                <div className="text-center pt-36">
                    ...
                    <p className="text-xl min-[500px]:text-center px-10 min-[500px]:px-36">Low-latency voice and video feel like you're in the same room. Wave hello over video, watch friends stream their games, or gather up and have a drawing session with screen share.</p>
                </div>
            ...
            <div className="bg-[#36393f]">
                <div className="pl-3 min-[500px]:pl-14">
                    <div className="flex flex-col min-[500px]:flex-row pt-16 pb-10">

                        <div className="text-white w-4/5 min-[500px]:w-1/5">
                        ...
                        <div className="w-4/5 min-[500px]:w-1/5 text-white text-start pl-4">
                        ...
                        <div className="w-4/5 min-[500px]:w-1/5 text-white text-start">
